# Create a terraform template to provision a Lambda Function and a step Function
...
module "step_function" {
  ...
  definition = <<EOF
{
  "Comment": "A Module two Assignment of the Amazon States Language using Pass states",
  "StartAt": "Module two",
  "States": {
    "Hello two": {
      "Type": "Pass",
